...
output1 <- ht_2pop_mean(x, y, delta = delta, sig_level = sig_level, conf_level = conf_level, alternative = "two.sided", var_equal = TRUE, na_rm = TRUE)
output2 <- t_test(x, y, alternative = "two.sided", mu = delta, conf.level = conf_level, var.equal = TRUE, na.rm = TRUE)
