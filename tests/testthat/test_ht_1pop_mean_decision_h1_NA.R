...
# Decision: H1
# t-test
output <- ht_1pop_mean(amostra, mu = mu0_1, sig_level = sig_level, conf_level = conf_level, na.rm = T)
...
# Decision: H1
# t-test
output <- ht_1pop_mean(amostra, mu = -1 * mu0_1, sig_level = sig_level, conf_level = conf_level, na.rm = T, alternative = "less")
...
# Decision: H1
# t-test
output <- ht_1pop_mean(amostra, mu = mu0_1, sig_level = sig_level, conf_level = conf_level, alternative = "greater", na.rm = TRUE)
...
# Decision: H1
# z-test
output <- ht_1pop_mean(amostra, mu = mu0_1, sig_level = sig_level, conf_level = conf_level, na.rm = T, sd_pop = sd_pop)
...
# Decision: H1
# t-test
output <- ht_1pop_mean(amostra, mu = -1 * mu0_1, sig_level = sig_level, conf_level = conf_level, na.rm = T, alternative = "less", sd_pop = sd_pop)
testthat::test_that("t-test less, decision H0",{
...
# Decision: H1
# t-test
output <- ht_1pop_mean(amostra, mu = mu0_1, sig_level = sig_level, conf_level = conf_level, na.rm = T, alternative = "greater", sd_pop = sd_pop)
testthat::test_that("t-test greater, decision H0",{
