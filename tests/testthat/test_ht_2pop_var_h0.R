...
testthat::test_that("ttest for comparing variances (ratio = 1), decidision H1, alternative = 'two.sided'", {
...
testthat::test_that("ttest for comparing variances (ratio = 1), decidision H1, alternative = 'greater'", {
...
testthat::test_that("ttest for comparing variances (ratio = 1), decidision H1, alternative = 'less'", {
  testthat::expect_equal(output1$statistic, output2$statistic)
  testthat::expect_equal(output1$p_value, output2$p_value)
  testthat::expect_equal(output1$lower_ci, output2$lower_ci)
  testthat::expect_equal(output1$upper_ci, output2$upper_ci)
